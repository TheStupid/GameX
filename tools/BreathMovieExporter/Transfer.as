package {
    ...
    public class Transfer {
        ...
        public function Transfer(movieContainer:MovieClip,swfFile:File, movie:MovieClip, raceId:int, exportParentFolder:File,afterTransfer:Function) {
        ...
        private function initExportFolder(parentFolder:File):void{
            ...
            var exportFolderPath:String = parentFolderPath + "\\peticon" + _raceId;
...
//                }
        ...
        public function doTransfer():void {
            this.currentClsConfig = "mmo.pet.peticon" + _raceId + ":";
...
//            return this._sourceFile.name.substring(0, (this._sourceFile.name.indexOf(this._sourceFile.extension) - 1));
        ...
        private function onFrameChange(event:Event):void {
            DocClass.instance.addLog("当前处理:第" + this._currentMovie.currentFrame + "帧");
