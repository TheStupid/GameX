const FILE_NAME_PREFIX = "egg";
const LINKAGE_CLASS_NAME_PREFIX = "mmo.pet.egg";
const ICON_WIDTH = 50;
...
function exportIcon(doc,item,id){
	...
	// item.width = ICON_WIDTH - 2;
	// item.height = ICON_WIDTH - 2;
	// item.x = 1;
	// item.y = 1;

	iconWidth = ICON_WIDTH - 2;
	...
	doc.exportPNG(exportFolderURL + "/export/egg" + id + ".png",true,true);
}
